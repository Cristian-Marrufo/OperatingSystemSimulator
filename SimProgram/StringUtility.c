...
/*
Name: compareString
Process: compare two strings with the following results:
...
Process: append one string onto another
...
void concatenateString( char *destStr, const char *sourceStr )
   {
      ...
      while(tempStr[sourceIndex] != NULL_CHAR && destIndex < MAX_STR_LEN )
         {
           // assign characters to end of destination
...
/*
Name: copyString
Process: copies one string into another, overwriting data in the
   destination string
Function Input/Parameters: c-style source string (char *)
Function Output/Parameters: c-style destination string (char *)
Function Output/Returned: none
      ...
      while( masterIndex < testStrLen )
         {
           ...
           // loop to end of test string while test string/sub string characters
           // are the same
...
int getStringLength( const char *testStr )
   {
      ...
      // loop to tend of string, protect from overflow
...
void getSubString( char *destStr, const char *sourceStr,
                   int startIndex, int endIndex )
   {
      // initialize function/variables
         ...
         // initialize the destination inde to zero
         int destIndex = 0;
...
Process: iterates through string, sets any upper case letters
