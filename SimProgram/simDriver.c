...
bool processCmdLine(int numArgs, char **strVector, CmdLineData *clDataPtr)
   {
            ...
            while(argIndex < numArgs)
               {
                  ...
                  // must be last four
                     ...
                     {
                        // find lenght to verify file name, file name must be
                        // last argument, and have ".cnf" extension
                        fileStrLen = getStringLength(strVector[numArgs-1]);
                        fileStrSubLoc = 
                                    findSubString(strVector[numArgs-1], ".cnf");

                        // verify string found and correct format for config
                        // file name
      ...
      // return verrification of at least one switch and correct file name
